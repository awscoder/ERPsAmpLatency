classdef ERPsAmpLatency_GUI < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function GenerateAmpLatency(app, event)
            ...
            ERPs.Regions.Chann = cellfun(@str2num,ERPs.Regions.Chann,'un',0);
            ...
            XLNameAmp = ['Results-BCI-ERPs-Amplitudes-',datestr(now,'mmmm-dd-yyyy_HH_MM_SS'),'.xlsx'];
            XLNameLat = ['Results-BCI-ERPs-Latency-',datestr(now,'mmmm-dd-yyyy_HH_MM_SS'),'.xlsx'];
            ...
            for f = 1:length(ERPs.Tags)
                ...
                for r = 1:length(ERPs.Regions.Chann) %Makes Regional Sheets
                    XLLine = 1;
                    
                    HeaderInd = (ERPs.Regions.Chann{r} .* ones(Num_Paradigms,1)*Num_Paradigms') - [Num_Paradigms-1:-1:0]';
                ...
                for r = 1:length(ERPs.Regions.Chann)
                    ElecPara_Indx = Num_Paradigms*(ERPs.Regions.Chann{r}-1)+Paradigm_Num_Array';
...
%                 end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.DatasetDirectoryEditField.Value = '\\secd.unl.edu\pittLab\VSD_EEG_motion\Data\Participant_EEG_data\P10 RESNA Analysis\Diff-Waves\';
            ...
            app.NumberofParticipantsEditField.Value = 10;
            ...
            app.StimulusStartTimeseg01Label.Text = 'Stimulus Start Time (s) e.g. 0.1';
            ...
            app.StimulusStartTimeseg01EditField_2.Value = 0.1;
            ...
            app.RegionsEditField.Value = '[2:3,30];[6:9,11:12,22:26,28:29];[13:20]';
            ...
            app.RegionLabelsEditField.Value = 'Frontal;Central;Parietal-Occipital';
            ...
            app.ERPsEditField.Value = 'P300;N170';
            ...
            app.ERPRangesEditField.Value = '0.200,0.700;0.090,0.230';
